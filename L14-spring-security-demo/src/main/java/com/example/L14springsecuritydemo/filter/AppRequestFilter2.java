...
@Component
@Order(100)
public class AppRequestFilter2 extends HttpFilter {
    private static Logger LOGGER = LoggerFactory.getLogger(AppRequestFilter2.class);
    ...
    public void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException, ServletException, IOException {
        LOGGER.info("Processing request in AppRequestFilter2");
